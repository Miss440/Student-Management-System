...
<body>
	...
	<div class="contact1">
		<div class="container-contact1">
			...
			<form class="contact1-form validate-form" action="Update">
				<span class="contact1-form-title">
					Update Student Details
				</span>

				<div class="wrap-input1 validate-input" data-validate = "ID is required">
					<input class="input1" type="text" name="sid" placeholder="Enter Student ID that you want to update">
				...
				<div class="wrap-input1 validate-input" data-validate = "Gender is required">
					<input class="input1" type="text" name="sgender" placeholder="Gender">
					<span class="shadow-input1"></span>
				</div>

				<div class="wrap-input1 validate-input" data-validate = "CGPA is required">
